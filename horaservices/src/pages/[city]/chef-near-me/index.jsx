...
const ChefCitypage = () => {
    ...
    return (
        <div className="page-width">
            <div className="party-services">
                ...
                <div className="chef-banner" style={styles.bannerChef}>
                    ...
                    <div className="banner-text" style={styles.bannerText}>
                        <h2 className="banner-insideHeading">Private Chef in {city.charAt(0).toUpperCase() + city.slice(1)}</h2>
                        <a href="#localities" className="hire-now">Hire Now</a>
                    </div>
                    <div className="banner-img" style={styles.bannerImg}>
                        <Image src={"../assets/chef-banner.jpg"} alt='chef banner'
                            width={1200}
                            height={200}
            ...
            {/* locality box */}
            <div className="localities-box" id="localities">
                <h2 className="heading-black" style={{borderBottom:"1px solid black"}}>
              ...
              <div className="chefWorkSection section-container localities-box"> 
                    <div id="how-it-works" >
                        <h2 className="heading-purple">How It Works</h2>
