    ...
    <div>
          ...
          <div className="service">
            ...
            <div className="service-image-container">
              <Image
                ...
                height={100}
              />
              <button className="book-now2" onClick={photographyUrl}>
                Book Now
              </button>
            </div>
          </div>
        ...
        <div style={styles.pageWidth}>
          <div id="faqQ">
            ...
            <div>
              ...
              <p>
                A: Visit our website or download our app and place the order by
                selecting your dish, number of people, date, and time of the
                event to secure their services for your event.
              </p>
            </div>
            <div>
              <strong>
                2: What makes your catering services the best for small parties
                in {city.toUpperCase()}?
              </strong>
              <p>
                A: Our catering services in {city.toUpperCase()} are tailored
                for small parties , We offer personalized options to make your
                event unforgettable.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                {city.toUpperCase()}, ensuring a unique dining experience for
                any occasion.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                your location on our platform, and choose from a list of dishes,
                number of people, date and time of event.
              </p>
            </div>
            <div>
              <strong>
                5: Is Book a cook in {city.toUpperCase()} suitable for
            ...
            <div>
              <strong>
                6: What sets your chefs for hire in {city.toUpperCase()} apart
                from others?
              </strong>
              <p>
                A: Our chefs in {city.toUpperCase()} are not only skilled but
                also verified, ensuring a high standard of service and culinary
                expertise.
              </p>
            </div>
            <div>
              ...
              <p>
                A: Certainly! Explore our selection of cooks available for hire
                at home in {city.toUpperCase()} to make your event memorable.
              </p>
            </div>
            <div>
              <strong>
                8: How do I take a chef in {city.toUpperCase()} for a
                personalized cooking experience?
              </strong>
              <p>
                A: Taking a chef in {city.toUpperCase()} is simple. Choose a
                chef, specify your preferences, and enjoy a personalized cooking
                experience in the comfort of your home.
              </p>
            </div>
            <div>
              <strong>
                9: Are your party caterers in {city.toUpperCase()} suitable for
                both small and large events?
              </strong>
              <p>
                A: Yes, our party caterers in {city.toUpperCase()} cater to a
                variety of events, from intimate gatherings to larger
                celebrations.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                for a night in {city.toUpperCase()} and create a culinary
            ...
            <div>
              <strong>
                ...
                {city.toUpperCase()} regularly?
              </strong>
              <p>
                A: Yes, you can hire a cook near you in {city.toUpperCase()} for
                regular cooking services. Choose a cook that fits your
            ...
            <div>
              ...
              <p>
                A: Finding the best home caterers in {city.toUpperCase()} is
                simple with our platform. Explore our options and choose the one
                that suits your needs.
              </p>
            </div>
            <div>
              <strong>
                14: Do you have top-rated cooks in {city.toUpperCase()}{" "}
                available for hire?
              </strong>
              <p>
                A: Yes, we have a selection of top-rated cooks in{" "}
                {city.toUpperCase()} available for hire. Explore their profiles
                and book the one that meets your requirements.
              </p>
            </div>
            <div>
              <strong>
                15: Can I hire a chef at home in {city.toUpperCase()} for a
                cooking demonstration?
              </strong>
              <p>
                A: Absolutely! Hire a chef at home in {city.toUpperCase()} for a
                cooking demonstration and learn culinary skills from a
                professional.
              </p>
            </div>
            <div>
              <strong>
                16: What is the difference between a private chef and a personal
                cook in {city.toUpperCase()}?
              </strong>
              <p>
            ...
            <div>
              <strong>
                17: Can I hire cooks on demand in {city.toUpperCase()} for
                last-minute gatherings?
              </strong>
              <p>
                A: Yes, our platform allows you to hire cooks on demand in{" "}
                {city.toUpperCase()}, making it convenient for spontaneous
                events.
              </p>
            </div>
            <div>
              <strong>
                18: How can I find local chefs for hire in {city.toUpperCase()}{" "}
                for a regional cuisine?
              </strong>
              <p>
                A: Finding local chefs for hire in {city.toUpperCase()} is easy.
                Specify your cuisine preferences, and our platform will display
                chefs with expertise in that cuisine.
              </p>
            </div>
            <div>
              <strong>
                19: Are there cooking maids near me in {city.toUpperCase()}{" "}
                available for hire?
              </strong>
              <p>
            ...
            <div>
              <strong>
                ...
                {city.toUpperCase()} for a romantic dinner?
              </strong>
              <p>
                A: Certainly! Hire a personal chef for a night in{" "}
                {city.toUpperCase()} and create a romantic dining experience in
                the comfort of your home
              </p>
            </div>
            <div>
              <strong>
                21: How do I hire a cook online in {city.toUpperCase()} for
                virtual cooking sessions?
              </strong>
              <p>
                A: Hiring a cook online in {city.toUpperCase()} for virtual
                cooking sessions is simple. Browse through available cooks,
                choose one, and arrange for an online cooking session.
              </p>
            </div>
            <div>
              <strong>
                22: : What makes your home cooking service in{" "}
                {city.toUpperCase()} unique?
              </strong>
              <p>
                A: Our home cooking service in {city.toUpperCase()} is unique
                due to our diverse selection of trained and verified cooks,
                ensuring a high-quality culinary experience
              </p>
            </div>
            <div>
              <strong>
                23: Can I book mini caterers in {city.toUpperCase()} for a small
                family gathering?
              </strong>
              <p>
                A: Absolutely! Our mini caterers in {city.toUpperCase()} are
                perfect for small family gatherings, providing a customized and
            ...
            <div>
              <strong>
                ...
                {city.toUpperCase()} for regular meals?
              </strong>
              <p>
                A: Hiring a private cook for home in {city.toUpperCase()} for
                regular meals is easy. Choose a cook that fits your preferences
                and schedule for consistent cooking services.
              </p>
            </div>
            <div>
              <strong>
                25: Are your private chef services near me in{" "}
                {city.toUpperCase()} available for special dietary requirements?
              </strong>
              <p>
                A: Yes, our private chef services near you in{" "}
                {city.toUpperCase()} are customizable to accommodate special
                dietary requirements. Discuss your needs with the selected chef
                to ensure a tailored culinary experience.
              </p>
            </div>
          </div>
          <p
      ...
      <section id="section7" class="sectionidsec">
        <div style={styles.pageWidth}>
            ...
            <div id="city-content">
              <div class="des-city-area">
                ...
                <p id="city-description">
                  Book professional Cooks and Chefs in {city} for House Parties,
                  Birthday Parties, Special Breakfast, Lunch and Dinner at Home.
                  Hire trained and verified personal Chefs and Cooks near you
                  for a private dining experience at home with the best cooks
                  and chef services at home.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            Online chef for hire in {city}, Chef in {city}, Best caterers for
            small parties in {city}, Best home-made cooking service in {city},
            Mini party caterers in {city}, Book a chef in {city}, Book a cook in{" "}
            {city}, Book a private chef in {city}, Book a private cook in {city}
            , Book a trained verified cook near you in {city}, Bookacook in{" "}
            {city}, Caterers for small parties in {city}, Top caterers in {city}
            , Chef for a party in {city}, Catering services in {city}, Chef at
            home service in {city}, Chef for a day in {city}, Chef for a night
            in {city}, Chef for hire in {city}, Chef cooking at my home in{" "}
            {city}, Chef near me in {city}, Chef on demand in {city}, Chef
            required at home in {city}, Chefs for hire in {city}, Chefs for home
            in {city}, Hire a private chef in {city}, Chefs on hire in {city},
            Cook chef near me in {city}, Cook at home services in {city}, Cook
            for a day in {city}, Cook for a night in {city}, Cook for one day in{" "}
            {city}, Cook for a party in {city}, Cook service near me in {city},
            Cook home services in {city}, Cook near me in {city}, Cook on demand
            in {city}, Cook on hire near me in {city}, Cook required at home in{" "}
            {city}, Cooking as a service in {city}, Cooking maids near me in{" "}
            {city}, Cooking services near me in {city}, Cooks for hire in {city}
            , Cooks for home in {city}, Cooks near me in {city}, Cooks on hire
            in {city}, Domestic cook near me in {city}, Find a chef in {city},
            Find a cook in {city}, Hire a chef in {city}, Hire a chef for a day
            in {city}, Hire personal chef in {city}, Hire a chef for home in{" "}
            {city}, Hire a chef near me in {city}, Take a Chef in {city}, Hire a
            cook in {city}, Hire a cook at home in {city}, Hire a cook for home
            in {city}, Hire a cook near me in {city}, Hire a personal chef for a
            night in {city}, Hire a personal cook in {city}, Hire a professional
            chef in {city}, Hire chef at home in {city}, Hire cook near me in{" "}
            {city}, Hire cook online in {city}, Hire private chef in {city},
            Hire someone to cook for you in {city}, Hiring a personal chef in{" "}
            {city}, Home caterers in {city}, Home chef near me in {city}, Home
            cook near me in {city}, Home cooking service in {city}, Home cooking
            service near me in {city}, Home party catering in {city}, House chef
            near me in {city}, House cook near me in {city}, In-home cooking
            service in {city}, In-house cooking service in {city}, Local chefs
            for hire in {city}, Looking for chef in {city}, Looking for cook in{" "}
            {city}, Mini caterers in {city}, Need a chef in {city}, Need a cook
            in {city}, Online cook service in {city}, Party caterers in {city},
            Personal chef in {city}, Personal chefs for hire near me in {city},
            Personal Cook in {city}, Personal cook near me in {city}, Private
            chef in {city}, Private chef hire in {city}, Private chef near me in{" "}
            {city}, Private chef services near me in {city}, Private cook in{" "}
            {city}, Private cook for hire in {city}, Private personal chef in{" "}
            {city}, Professional chef for hire in {city}, Top rated chefs in{" "}
            {city}, Top rated cooks in {city}, Want to hire a cook in {city}
          </p>
        </div>
      </section>
    </div>
