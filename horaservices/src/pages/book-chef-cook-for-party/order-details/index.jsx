...
const SelectDate = () => {
  ...
  useEffect(() => {
    ...
    const peopleCharge =
      numericPeopleCount > 1 ? (numericPeopleCount - 1) * 49 : 0;
  ...
  const getTotalBurnerCount = () => {
    ...
    if (totalBurnerCount <= 6) return 2;
    else if (totalBurnerCount > 6 && totalBurnerCount < 10) return 3;
    else if (totalBurnerCount > 10) return 4;
  };
  ...
  const defaultImage =
    "https://play-lh.googleusercontent.com/a-/ALV-UjXtTD4G9gbxQz1RSCSnAEkBxESsZuZI2pSfXLzd6WjXDJ3muobz6w=s32-rw"; // Replace with the path to your default image
  ...
  const RenderIngredients = ({ key, item }) => {
    ...
    return (
      ...
      >
        ...
        >
          <div
            style={{ fontSize: "70%", fontWeight: "500", color: "#414141" }}
      ...
      <>
        ...
        >
          <div
            ...
            className="req-applicance-details"
          >
            <p
              style={{ color: "#000000", fontSize: "100%", fontWeight: "400" }}
            >
              Required Burners
            </p>
            <p
              style={{ color: "#969696", fontSize: "100%", fontWeight: "400" }}
            >
              Number of burners depend upon the number of dishes chosen
            </p>
            <p
              style={{ color: "#969696", fontSize: "100%", fontWeight: "400" }}
            >
      ...
      >
        ...
        >
          <div style={{ flexDirection: "column", display: "flex" }}>
            ...
            >
              (Keep these ingredient ready at your location)
            </span>
          </div>

          <div
            style={{ flexDirection: "row", marginTop: "15px", display: "flex" }}
          >
            <ListGroup
              style={{
                display: "flex",
  ...
  // SelectDate component ke andar, return se pehle:
  const SITE = "https://horaservices.com";

  const pathOnly =
    (router.asPath || "").split("?")[0] ||
    router.pathname ||
    "/book-chef-select-date"; // ← apna real route daalo
        ...
        >
          ...
          <div>
            ...
            >
              ...
              >
                <span
                  style={{ color: "#000", fontSize: "100%", fontWeight: "800" }}
                >
                  Required{" "}
                </span>
                <span
            ...
            >
              <p
                ...
                className="req-des"
              >
                Keep these Appliances and Ingredients ready before chef Arrival
              </p>
            </div>
          </div>
          <div
