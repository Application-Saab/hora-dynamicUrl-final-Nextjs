...
//   const { productName, catValue, city, locality } = context.params || {};
...
//   // ---- Related products (Similar / You May Also Like) ----
...
//   // }, [product, catValue]);
//   useEffect(() => {
//     if (initialAllProducts?.length) return; // already have SSR data
//     if (product?.categoryId) getCategoryProducts(product.categoryId);
//     else if (catValue) getSubCatId(catValue);
//   }, [product, catValue]);
