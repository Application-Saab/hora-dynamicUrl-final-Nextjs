...
//                   } else if (
//                     router.pathname === "/balloon-decoration/[catValue]"
//                   ) {
...
//                   } else if (
//                     router.pathname === "/[city]/balloon-decoration/[catValue]"
//                   ) {
...
function MyApp({ Component, pageProps }) {
  ...
  useEffect(() => {
    ...
    requestIdleCallback(() => {
      ...
      script.async = true;
      script.src = "https://www.googletagmanager.com/gtm.js?id=GTM-K3SCKLTZ";
  ...
  const handleWhatsAppClick = () => {
    if (router.pathname === "/balloon-decoration") {
      trackEvent("decoration_page_whatsappclick", "decoration page whatsapp button clicked");
    } else if (router.pathname === "/book-chef-cook-for-party") {
      trackEvent("chefforparty_page_whatsappclick", "chef for party page whatsapp button clicked");
    } else if (router.pathname === "/balloon-decoration/[catValue]") {
      trackEvent("decoration_productlistedpage_whatsapp_click", `decoration_productlist_categorypage_whatsapp_click_${catValue}`);
    } else if (router.pathname === "/balloon-decoration/[catValue]/product/[productName]") {
      trackEvent("decoration_productpage_whatsapp_click", `decoration_productpage_whatsapp_click_${productName}`);
    } else if (router.pathname === "/[city]/balloon-decoration") {
      trackEvent("decoration_citypage_whatsappclick", "decoration page whatsapp button clicked");
    } else if (router.pathname === "/[city]/balloon-decoration/[catValue]") {
      trackEvent("decoration_productlistedcitypage_whatsapp_click", "decoration_productlistedcitypage_whatsapp_click");
    } else if (router.pathname === "/[city]/balloon-decoration/[catValue]/product/[productName]") {
      trackEvent("decoration_productcitypage_whatsapp_click", "decoration_productcitypage_whatsapp_click");
    }
  };
        ...
        <PageLayout>
          ...
          <div>
            ...
            <Link href="https://wa.me/+917338584828/?text=Hi%2CI%20saw%20your%20website%20and%20want%20to%20know%20more%20about%20the%20services" target="_blank">
              <Image className="whatappicon" src={whatsppicon} alt="WhatsApp Icon" onClick={handleWhatsAppClick} />
            </Link>
          </div>
        </PageLayout>
      </PersistGate>
