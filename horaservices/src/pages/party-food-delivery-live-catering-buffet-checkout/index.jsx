  ...
  return (
    <div className="App">
      <Head>
        ...
        {/* Checkout = private funnel → noindex */}
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  {pinCode && (
                    <p
                      className={`p-0 m-0 ${pinCodeError ? "text-danger" : "text-success"}`}
                    >{`Service ${pinCodeError ? "not" : ""} available in your area!`}</p>
                  )}
                </div>
                <div
                  style={{
...
export const CustomDatePicker = ({
  ...
  return (
    <div
      className={`timepkerSec  d-flex flex-column border border-1 rounded-4 p-2  ${combinedDateTimeError ? "border-danger" : ""} `}
    >
      <p
        style={{
          marginBottom: "4px",
...
export const CustomTimePicker = ({
  ...
  return (
    <div
      className={`timepkerSec d-flex flex-column border border-1 ${combinedDateTimeError ? "border-danger" : ""}  ${selectedTimeSlotError ? "border-danger" : ""} rounded-4 p-2`}
    >
      <p
        style={{
          marginBottom: "4px",
