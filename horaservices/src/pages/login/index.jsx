...
const Login = () => {
        ...
        if (response.data.status === API_SUCCESS_CODE) {
          ...
          if (previousPage) {
            if (previousPage.includes("/book-chef-cook-for-party")) {
              ...
              previousPage.includes(`/balloon-decoration/${catValue}/product`)
            ) {
              router.push({
                pathname: "/checkout",
                query: {
              ...
              previousPage.includes(
                "/party-food-delivery-live-catering-buffet-select-date"
              )
            ) {
              router.push({
              ...
              previousPage.startsWith(
                "/balloon-decoration/birthday-decoration/product/"
              )
            ) {
              router.push({
                pathname: "/checkout",
  ...
  return (
    ...
    >
        <Head>
  <title>Login - Access Your Hora Services Account</title>
  <meta name="description" content="Log in to your Hora Services account to manage your bookings, access party decoration and chef services, and plan your next celebration with ease!" />
  <meta name="keywords" content="login, user login, access account, hora services login, login to account, event planning login, decoration services, chef booking login, user authentication" />
  <meta property="og:title" content="Login - Access Your Hora Services Account" />
  <meta property="og:description" content="Sign in to your Hora Services account to manage your party bookings, hire chefs, and access event decoration services. Secure and easy login for our valued customers." />
  <meta property="og:image" content="https://horaservices.com/api/uploads/logo-icon.png" />
  <meta property="og:image:alt" content="Login page for Hora Services" />
  {/* <script type="application/ld+json">{scriptTag}</script> */}
  <meta name="robots" content="noindex, nofollow" />
  <meta name="author" content="Hora Services" />
  <link rel="icon" href="https://horaservices.com/api/uploads/logo-icon.png" type="image/x-icon" />
  <meta property="og:url" content="https://horaservices.com/login" />
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  {previousPage === "/orderlist" ? "to check your Orders" : ""}
                </p>{" "}
                <div className="row gap-1 justify-content-around">
                  <div className="col-2 p-0 m-0 text-center">
                    <p className="form-control rounded-2 phone-code font-16px m-0 py-3">
                      +91
                    </p>
                  </div>
