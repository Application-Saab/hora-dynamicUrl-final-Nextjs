  ...
  return (
    <>
      <div className="page-width">
        <Head>
          <title>
            HORA Caterers: Tailored Modern Catering – Choose, Customize, Book!
          </title>
          <meta
            name="description"
            content="Discover HORA Catering for exquisite veg and non-veg options, featuring a diverse menu including Chinese, North Indian, Italian, and Continental cuisines. 🍽️ Perfect for house parties, corporate events, weddings, and birthday celebrations! 🎉 We ensure your occasion is deliciously memorable. 🌟 Customize your menu today! 😊🎈"
          />
          <meta
            name="keywords"
            content="HORA Caterers: Tailored Modern Catering – Choose, Customize, Book!"
          />
          <meta
            property="og:title"
            content="HORA Caterers: Tailored Modern Catering – Choose, Customize, Book!"
