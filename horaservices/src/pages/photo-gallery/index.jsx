...
const PhotoGallery = () => {
  ...
  // SSR-safe query params (window mat use karo render pe)
  const folderName = router.isReady
    ? (router.query.folderName || null)
    : null;
  const customerId = router.isReady
    ? (router.query.customerId || null)
    : null;
    ...
    >
      <Head>
        ...
        <link
          ...
          href={
            folderName
              ? `https://horaservices.com/photo-gallery?folderName=${encodeURIComponent(
                  folderName
                )}`
              : `https://horaservices.com/photo-gallery`
          }
