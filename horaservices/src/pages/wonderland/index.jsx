...
const InvitationCard = () => {
  ...
  const [hasSubmitted, setHasSubmitted] = useState(false);
  const [showNotifyPermissionMsg, setNotifyPermissionMsg] = useState(false);
  const [isUnsupportedBrowser, setIsUnsupportedBrowser] = useState(false); // New state for unsupported browser
  console.log(
    "%c [ guestDetails ]-60",
    "font-size:13px; background:pink; color:#bf2c9f;",
    guestDetails
  ...
  const [showImageUploadInfo, setShowImageUploadInfo] = useState(false);
  const GOOGLE_SCRIPT_URL =
    "https://script.google.com/macros/s/AKfycbyU06csCT5OIJzO3F9VGTjCIli74-k2puAp8AhybJGHPYvyEmuQmJlvPf60wHsy--NGGg/exec";
  ...
  const actions = [
    { image: tabIcon1, title: "Upload Pictures" },
    { image: tabIcon2, title: "Thank You Note" },
  ];
...
//       const messaging = getMessaging(); // Modular SDK
                ...
                <>
                  {isUnsupportedBrowser && (
                    <div className="notification-message">
                      Notifications not supported in Chrome on iOS. Please use
