    ...
    <>
      ...
      <div className="page-width">
        ...
        <p>
          ...
          use of Horaservices.com. By accessing this website, we assume you
          accept these terms and conditions. Do not continue to use Hora
          Services if you do not agree to take all of the terms and conditions
          stated on this page.
        </p>

        <h2>Cancellation and order change policy for Decoration</h2>
        ...
        <p>
          3. If the order is cancelled within 24 hours: The full advance amount
          will be non-refundable, and 100% of the payment for decoration has to
          be paid by customer.
        </p>

        <p>
          4. In case of eligibility refunds, the refund should be initiated
          within 48 hours of order cancellation.
        </p>

        <h2>
          Cancellation and order change policy for Food delivery, Live catering
          and chef service
        </h2>

        <p>
          1. If the order is not assigned to the kitchen: You are eligible for
          a 100% refund of the advance payment.
        </p>

        <p>
          2. If the order is cancelled more than 24 hours before the scheduled
          delivery: You will receive a 50% refund of the advance payment.
        </p>

        <p>
          3. If the order is cancelled within 24 hours of the scheduled
          delivery: The full advance amount will be non-refundable, and 100% of
        ...
        <h2>Cancellation and order change policy for photography</h2>

        <p>
          1. If the order is beyond 48 hours: You are eligible for a 100%
          refund of the advance payment.
        </p>
        ...
        <p>
          ...
          "You", and "Your" refers to you, the person logging on this website
          and compliant with the Company’s terms and conditions. "The Company",
        ...
        <p>
          We employ the use of cookies. By accessing Hora Services, you agreed
          to use cookies in agreement with Hora Service's Privacy Policy. Most
        ...
        <p>
          Unless otherwise stated, Hora Services and/or its licensors own the
          intellectual property rights for all material on Horaservices.com.
          All intellectual property rights are reserved. You may access this
          from Horaservices.com for your own personal use subjected to
        ...
        <p>
          ...
          Hora Services does not filter, edit, publish, or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Hora Services, its agents, and/or affiliates.
          Comments reflect the views and opinions of the person who posts their
          views and opinions. To the extent permitted by applicable laws, Hora
        ...
        <p>
          Hora Services reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Hora Services a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Hora Services; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Hora Services. Please include your name, your
        ...
        <ul>
          ...
          <li>
            ...
            makes sense within the context and format of the linking party’s
            site.
          </li>
        </ul>

        <p>
          No use of Hora Services's logo or other artwork will be allowed for
