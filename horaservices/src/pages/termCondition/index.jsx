  ...
  return (
    <div class="page-width">
        ...
        <h2>Cancellation and order change policy for Decoration</h2>
                    ...
                    <p>4. In case of eligibility refunds, the refund should be initiated within 48 hours of order cancellation.</p>
          
    
        <h2>Cancellation and order change policy for Food delivery, Live catering and chef service</h2>
    <p>1. If the order is not assigned to the kitchen: You are eligible for a 100% refund of the advance payment.</p>
    <p>2. If the order is cancelled more than 24 hours before the scheduled delivery: You will receive a 50% refund of the advance payment.</p>
    <p>3. If the order is cancelled within 24 hours of the scheduled delivery: The full advance amount will be non-refundable, and 100% of the payment is required.</p>
    <p>4. In case of eligibility refunds, the refund should be initiated within 48 hours of order cancellation.</p>

        <h2>Cancellation and order change policy for photography</h2>
    <p>1. If the order is beyond 48 hours: You are eligible for a 100% refund of the advance payment.</p>
    <p>2. If the order is cancelled more than 24 hours before the scheduled delivery: You will not receive refund of the advance payment.</p>
    <p>3. If the order is cancelled within 24 hours: The full advance amount will be non-refundable, and 100% of the payment for decoration has to be paid by customer.</p>
    <p>4. In case of eligibility refunds, the refund should be initiated within 48 hours of order cancellation.</p>
