...
useEffect(() => {
  ...
  return (
    ...
    || routerPathname === "/pune" || routerPathname === "/surat" || routerPathname === "/bhopal" || routerPathname === "/lucknow" || routerPathname === "/goa" || routerPathname === "/lucky-draw" ||  routerPathname?.startsWith("/wonderland/")
     ?  (
