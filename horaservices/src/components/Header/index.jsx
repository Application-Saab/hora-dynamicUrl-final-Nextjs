...
const Drawer = ({ closeDrawer, drawerRef, handleLogout }) => {
  ...
  return (
    <div style={style.drawer} ref={drawerRef}>
      ...
      <Link href="/" style={style.drawerLink} onClick={() => { mobileMenuClicked('Entertainment'); closeDrawer(); }}>
        Entertainment
      </Link>
      <Link href="/" style={style.drawerLink} onClick={() => { mobileMenuClicked('Hospitality Service'); closeDrawer(); }}>
        Hospitality Service
      </Link>
      ...
      {localStorage.getItem("isLoggedIn") !== "true" ? (
        ...
        <>
          <Link href="/" style={style.drawerLink}
          onClick={() => { mobileMenuClicked('Logout'); handleLogout(); closeDrawer(); }}>
            Logout
          </Link>
        </>
      )}
