...
useEffect(() => {
  ...
  return (
    ...
    || routerPathname === "/pune" || routerPathname === "/surat" || routerPathname === "/bhopal" || routerPathname === "/lucknow" || routerPathname === "/goa" || routerPathname === "/lucky-draw" || routerPathname === "/wonderland" || routerPathname === "/chat" || routerPathname === '/accounts' || routerPathname === '/wonderland/create-invite-template' || routerPathname === '/templates' || routerPathname === '/services'
     ?  (
