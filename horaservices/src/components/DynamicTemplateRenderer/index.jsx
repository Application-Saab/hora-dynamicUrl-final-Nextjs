...
//   try {
//     const previewElement = document.getElementById("invite-preview");
...
//     // 1. Capture preview as image (skipFonts fixes cssRules SecurityError)
//     let dataUrl;
//     try {
...
//       });
//     } catch (err) {
//       console.error("Error converting preview to image:", err);
//       alert("Image conversion failed!");
//       return;
//     }

//     // 2. Save Image via external-template API
//     try {
//       const payload = {
//         userId,
//         image: dataUrl,
...
//       if (!res1.ok) throw new Error("Failed to save invite image");
//       console.log("Invite image saved!");
//     } catch (err) {
//       console.error("Error saving image API:", err);
//     }

//     // 3. Update normal invite API
//     try {
//       const res2 = await fetch(
//         `${BASE_URL}/api/customer/event/event-invites/update/${eventId}`,
//         {
//           method: "PUT",
//           headers: {
//             "Content-Type": "application/json",
...
//       if (!res2.ok) throw new Error("Failed to update invite details");

//       alert("Invite Updated & Image Saved Successfully!");
//     } catch (err) {
//       console.error("Error updating invite details:", err);
//       alert("Invite details update failed!");
//     }
//   } catch (error) {
...
//   return (
//     <div style={{ padding: "20px" }}id="invite-preview">
...
//     //   : "none",
//    backgroundImage: `url('/pastel-purpleBallons.webp')` ,// ✅ this is fine
