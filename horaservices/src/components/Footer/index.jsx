...
const footerColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { text: 'Bengaluru', to: '/bengaluru/book-chef-cook-for-party', city: 'Bengaluru' },
      ...
      { text: 'Indore', to: '/indore/book-chef-cook-for-party', city: 'Indore' },
      { text: 'Chennai', to: '/chennai/book-chef-cook-for-party', city: 'Chennai' },
      { text: 'Pune', to: '/pune/book-chef-cook-for-party', city: 'Pune' },
      { text: 'Surat', to: '/surat/book-chef-cook-for-party', city: 'Surat' },
      { text: 'Bhopal', to: '/bhopal/book-chef-cook-for-party', city: 'Bhopal' },
      { text: 'Kanpur', to: '/kanpur/book-chef-cook-for-party', city: 'Kanpur' },
      { text: 'Lucknow', to: '/lucknow/book-chef-cook-for-party', city: 'Lucknow' },
      { text: 'Goa', to: '/goa/book-chef-cook-for-party', city: 'Goa' },
    ],
  },
  {
